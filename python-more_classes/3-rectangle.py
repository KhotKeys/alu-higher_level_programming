...
class Rectangle:
    """
    #write a class rectangle that define the class of rectangular by:
    #....(based on the 2-rectangle.py)
    ...
    def __init__(self, width=0, height=0):
        ...
        def area(self):
            """This method calculate and return the area of a triangle.....which means
            you must multiple the width and the height. it uses the private
            attributes as '__width' and '__height' to perform the calculation"""
